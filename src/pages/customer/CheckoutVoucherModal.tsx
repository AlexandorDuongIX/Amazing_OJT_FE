...
import { Table, Button, Input, Tag, Space, Modal, Form, message, Popconfirm, DatePicker, InputNumber } from 'antd';
  ...
  return (
    <Form form={form} layout="vertical">
      ...
      <Form.Item
        name="value"
        label="Value"
        rules={[{ required: true, message: 'Please enter the promotion value' }]}
      >
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: 'Please select the valid date range' }]}
      >
